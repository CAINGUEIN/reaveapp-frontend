<template>
  <div class="space-y-4 max-w-7xl w-[95%] mx-auto mt-8">
    <div>
      <p class="font-black text-xl text-white">Categories</p>
        ...
        <table class="min-w-full divide-y divide-LightGrey">
          <thead class="border-b-2 border-LightGrey">
            <tr>
              ...
              <th
                scope="col"
                class="text-center text-base font-black text-LightGrey"
              >
                PRICE
              </th>
              <th
          ...
          <tbody>
            <tr v-for="item in data.tickets" :key="item._id">
              ...
              <td>
                <p
                  class="text-base text-LightGrey"
                >{{ $dayjs(data.openDate).format("DD/MM/YYYY") }}</p>
              </td>
              <td>
...
import Format from "../logistics/Format.vue";
