  ...
  <div name="layout" class="flex justify-between items-center">
    <p class="flex items-center">
      ...
      <button class="ml-6 text-left pl-3 pr-4 py-1 my-0.5 flex items-center text-base 
            font-black text-Gravel bg-DarkRock rounded-full h-10">
        <SvgTarget target="Overview" :height="20" :width="20" color1="#808080" class="mr-2"></SvgTarget>
        See Venue Page Preview
      </button>

      <button class="ml-6 text-left pl-3 pr-4 py-1 my-0.5 flex items-center text-base 
            font-black text-Gravel bg-DarkRock rounded-full h-10">
        <SvgTarget target="Maps" :height="20" :width="20" color1="#808080" class="mr-2"></SvgTarget>
        See Reave Maps Preview
      </button>
    </p>
...
Primary Photo</pre>
    ...
    <div name="divForSecondaryImages" class="flex gap-4 w-[62rem] h-[316px] flex-wrap mt-4">
    ...
    <div class="flex gap-8 mt-5">
      <div class="flex gap-3">
        ...
        <div class="flex flex-col">
          <pre class="text-sm font-sans text-LightGrey font-medium 
        leading-none">
The venue's page
accessible by anyone.</pre>
          <p class="text-xs mt-2 text-Blue underline cursor-pointer">Show preview</p>
        </div>
...
<div class="flex mt-6">
  <div class="flex-[0.7] flex flex-col gap-2">
    ...
    <p class="text-LightGrey font-normal text-base">Play a role in tourism, by inviting event attendees help the local places around.</p>
...
<div class="flex items-center gap-3">
  ...
  <div class="flex-[0.7] flex flex-col gap-2">
    ...
    <pre class="text-LightGrey font-normal text-base font-sans">
...
<div class="flex mt-6">
  <div class="flex-[0.7] flex flex-col gap-2">
    ...
    <p class="text-LightGrey font-normal text-base">These features will only be seen by potential organisers in their operator when searching for venues for their events.</p>
...
<div name="separateEvent" class="h-[2px] w-full bg-LightRock mt-4"></div>
    ...
    <pre class="text-LightGrey font-normal text-base mt-4 font-sans">
